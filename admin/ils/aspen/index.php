...
<?php
            include "../../../config.php";
            $stmt = $con->prepare("SELECT libraries.id, libraries.library_name, libraries.library_abbr, aspen.url FROM libraries JOIN aspen ON libraries.id = aspen.library_id ORDER BY libraries.library_name ASC");
        	$stmt->execute();
        	...
        	while ($row = $result->fetch_assoc()) {
                ...
                <tr id="<?php echo $id; ?>">
                    ...
                    <td><?php echo $name; ?></td>
                    <td class='sm'><a href='<?php echo $url; ?>'><?php echo $url; ?></a></td>
